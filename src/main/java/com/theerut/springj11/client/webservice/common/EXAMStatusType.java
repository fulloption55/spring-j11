...
/**
 * <p>Java class for EXAM_Status_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="EXAM_Status_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element ref="{urn:ifxforum-org:XSD:1}EXAM_AdditionalStatus" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "EXAM_Status_Type", propOrder = {
    "statusCode",
    "severity",
    "statusDesc",
    "examSubjectElement",
    "examAdditionalStatus",
    "asyncRsInfo"
})
public class EXAMStatusType {
    ...
    @XmlElement(name = "EXAM_AdditionalStatus")
    protected List<EXAMAdditionalStatusType> examAdditionalStatus;
    ...
    /**
     * Gets the value of the examAdditionalStatus property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the examAdditionalStatus property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEXAMAdditionalStatus().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link EXAMAdditionalStatusType }
     * 
     * 
     */
    public List<EXAMAdditionalStatusType> getEXAMAdditionalStatus() {
        if (examAdditionalStatus == null) {
            examAdditionalStatus = new ArrayList<>();
        }
        return this.examAdditionalStatus;
    }
