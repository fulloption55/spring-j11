...
import com.theerut.springj11.service.model.KycStatus;
...
@Data
@Builder
public class CreateAccountV3Request {
    ...
    @JsonProperty("is_request_debit")
    private Boolean isRequestDebit = false;
